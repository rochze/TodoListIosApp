...
class ToDoTableViewController: UITableViewController, TodoCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        loadData()
//        let todoItem = TodoItem(title: "Meeting on Jakarta", completed: false, createAt: Date(), itemIdentifier: UUID())
//        todoItem.saveItem()
...
//        print(todos)
    ...
    @IBAction func addNewItem(_ sender: Any) {
        ...
        addAlert.addAction(UIAlertAction(title: "Create", style: .default, handler: { (action:UIAlertAction) in
            ...
            let newTodo = TodoItem(title: title, completed: false, createAt: Date(), itemIdentifier: UUID())
            newTodo.saveItem()
